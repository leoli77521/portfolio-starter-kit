...
export default function PrivacyPage() {
    return (
        <section className="max-w-3xl mx-auto px-4 py-12">
            <h1 className="text-3xl font-bold mb-8 text-gray-900 theme-dark:text-gray-100">Privacy Policy</h1>
            <div className="prose theme-dark:prose-invert max-w-none text-gray-700 theme-dark:text-gray-300">
                <p className="mb-4">Last updated: {new Date().toLocaleDateString()}</p>

                <h2 className="text-2xl font-semibold mt-8 mb-4 text-gray-900 theme-dark:text-gray-100">1. Introduction</h2>
                <p className="mb-4">
                ...
                <h2 className="text-2xl font-semibold mt-8 mb-4 text-gray-900 theme-dark:text-gray-100">2. Information We Collect</h2>
                <p className="mb-4">
                ...
                <h2 className="text-2xl font-semibold mt-8 mb-4 text-gray-900 theme-dark:text-gray-100">3. Use of Cookies and Web Beacons</h2>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-semibold mt-6 mb-3 text-gray-900 theme-dark:text-gray-100">Google AdSense</h3>
                <p className="mb-4">
                ...
                <ul className="list-disc pl-6 mb-4 space-y-2">
                    ...
                    <li>
                        Users may opt out of personalized advertising by visiting <a href="https://www.google.com/settings/ads" target="_blank" rel="noopener noreferrer" className="text-blue-600 theme-dark:text-blue-400 hover:underline">Google Ads Settings</a>.
                    </li>
                </ul>

                <h2 className="text-2xl font-semibold mt-8 mb-4 text-gray-900 theme-dark:text-gray-100">4. Third-Party Websites</h2>
                <p className="mb-4">
                ...
                <h2 className="text-2xl font-semibold mt-8 mb-4 text-gray-900 theme-dark:text-gray-100">5. Contact Us</h2>
                <p className="mb-4">
