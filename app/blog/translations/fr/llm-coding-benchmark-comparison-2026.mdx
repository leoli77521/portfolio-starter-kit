...
seoTitle: "Scores de référence LLM 2026 : sources et compromis"
...
---
*Mise à jour éditoriale : 21 août 2026. Les instantanés de référence numériques ont été examinés pour la dernière fois le 8 juin 2026 ; L'accessibilité de la source et la fraîcheur de la page modèle ont été revérifiées le 21 août. Vérifiez les classements en direct avant de prendre une décision d'achat ou de migration.*
...
| **DeepSeek V3.2 / V3.2-Spécial** | Banc SWE résolu : **70** | GPQA Diamant : **74,24 / 82,4** ; MMLU-Pro : **85** | Forte capacité de raisonnement et de codage axé sur la valeur, en particulier lorsque le coût compte | [Carte modèle DeepSeek V3.2] (https://huggingface.co/deepseek-ai/DeepSeek-V3.2) | Carte modèle |
