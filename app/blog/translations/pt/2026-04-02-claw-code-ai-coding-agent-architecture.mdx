---
title: "Código de garra: arquitetura do agente de codificação de IA explicada"
summary: "Os documentos públicos e o repositório de paridade do Claw Code revelam como um agente de codificação de IA é montado: loop de tempo de execução, ferramentas, permissões, conexões MCP, sessões e plug-ins."
seoTitle: "Código de garra: arquitetura do agente de codificação de IA"
seoDescription: "O que é o Código da Garra? Explore o tempo de execução, as ferramentas, as permissões, as conexões MCP, as sessões e os pontos de extensão que fazem um agente de codificação de IA funcionar."
...
---
## O que é código de garra?

**Claw Code é uma arquitetura de agente de codificação de IA que vale a pena estudar porque seus materiais públicos expõem o sistema em torno do modelo:** uma interface de comando, loop de tempo de execução, registro de ferramentas, portas de permissão, conexões MCP, memória de sessão e pontos de extensão. É um modelo útil para avaliar se um agente de codificação pode executar o trabalho de forma segura e repetida, em vez de apenas gerar código.
