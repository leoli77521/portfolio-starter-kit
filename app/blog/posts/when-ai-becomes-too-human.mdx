...
image: "/og?title=when%20ai%20becomes%20too%20human"
...
faq: [{"question":"What is the main risk of companion chatbots?","answer":"They can reinforce emotional dependency and discourage real-world help-seeking."},{"question":"What safeguards are required?","answer":"Age gates, crisis escalation, and auditable safety logs."}]
howto: [{"name":"Add crisis detection","text":"Monitor for self-harm signals and trigger escalation flows."},{"name":"Enforce age gates","text":"Use verified age checks and guardian consent for minors."},{"name":"Audit safety drift","text":"Review long-session behavior to ensure guardrails hold."}]
---

## Related reading

Continue with the [AI detection evaluation guide](/blog/ai-detection-evaluation-guide) and the [enterprise AI governance hub](/topics/enterprise-ai-governance) for review and policy controls.
