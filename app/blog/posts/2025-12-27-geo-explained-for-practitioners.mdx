...
faq: [{"question":"What is GEO?","answer":"GEO structures content so generative engines can retrieve, trust, and cite it."},{"question":"How is GEO different from SEO?","answer":"SEO targets clicks; GEO targets citations inside AI-generated answers."}]
howto: [{"name":"Define the core term","text":"Place a clear, one-sentence definition in the first 150 words."},{"name":"Add structure","text":"Use headings, lists, and tables to create machine-parseable chunks."},{"name":"Anchor claims","text":"Link key statistics to primary sources to improve trust."}]
---
