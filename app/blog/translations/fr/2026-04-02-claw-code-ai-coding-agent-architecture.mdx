---
title: "Claw Code : explication de l'architecture de l'agent de codage IA"
summary: "Les documents publics et le référentiel de parité de Claw Code révèlent comment un agent de codage IA est assemblé : boucle d'exécution, outils, autorisations, connexions MCP, sessions et plugins."
seoTitle: "Claw Code : Architecture d'agent de codage IA"
seoDescription: "Qu'est-ce que le code des griffes ? Explorez le moteur d'exécution, les outils, les autorisations, les connexions MCP, les sessions et les points d'extension qui font fonctionner un agent de codage IA."
...
---
## Qu'est-ce que le code des griffes ?

**Claw Code est une architecture d'agent de codage d'IA qui mérite d'être étudiée car ses documents publics exposent le système autour du modèle :** une interface de commande, une boucle d'exécution, un registre d'outils, des portes d'autorisation, des connexions MCP, une mémoire de session et des points d'extension. Il s’agit d’un modèle utile pour évaluer si un agent de codage peut effectuer un travail en toute sécurité et de manière répétée plutôt que de simplement générer du code.
