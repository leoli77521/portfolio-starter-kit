---
title: "Claw Code: AI Coding Agent-Architektur erklärt"
summary: "Die öffentlichen Dokumente und das Paritäts-Repo von Claw Code zeigen, wie ein KI-Coding-Agent aufgebaut ist: Laufzeitschleife, Tools, Berechtigungen, MCP-Verbindungen, Sitzungen und Plugins."
seoTitle: "Claw Code: AI Coding Agent Architecture"
seoDescription: "Was ist der Claw Code? Entdecken Sie die Laufzeit, Tools, Berechtigungen, MCP-Verbindungen, Sitzungen und Erweiterungspunkte, die einen KI-Codierungsagenten zum Funktionieren bringen."
...
---
## Was ist der Claw Code?

**Claw Code ist eine KI-Coding-Agent-Architektur, die es wert ist, untersucht zu werden, da ihre öffentlichen Materialien das System rund um das Modell offenlegen:** eine Befehlsschnittstelle, eine Laufzeitschleife, eine Tool-Registrierung, Berechtigungstore, MCP-Verbindungen, Sitzungsspeicher und Erweiterungspunkte. Dies ist eine nützliche Blaupause für die Bewertung, ob ein Codierungsagent Arbeiten sicher und wiederholt ausführen kann, anstatt lediglich Code zu generieren.
