...
summary: "On March 6, 2026, Anthropic and Mozilla said Claude-assisted research helped uncover 22 Firefox CVEs, signaling AI's move into real security work."
image: "/og?title=Claude%20Helped%20Uncover%2022%20Firefox%20CVEs"
...
On **March 6, 2026**, [Anthropic](https://www.anthropic.com/coordinated-vulnerability-disclosure) and [Mozilla](https://blog.mozilla.org/en/firefox/hardening-firefox-anthropic-red-team/) disclosed something much bigger: Claude-assisted research helped uncover a wave of Firefox vulnerabilities. Mozilla said the collaboration contributed to **22 CVEs**, **14 high-severity bugs**, and **90 additional bugs**. Anthropic also published a separate [technical exploit write-up](https://red.anthropic.com/2026/exploit/) showing how Claude, under expert guidance, helped produce a working exploit for **CVE-2026-2796**.
